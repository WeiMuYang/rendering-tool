...
void Material::updateShapeShader() {
    ...
    // material
    shader_Shape.setUniformValue("material.ambient", material.ambient);
    shader_Shape.setUniformValue("material.diffuse", material.diffuse);
    shader_Shape.setUniformValue("material.specular", material.specular);
    shader_Shape.setUniformValue("material.shininess", material.shininess);
    // light
